...
$(".default-value").click(function () {
 ...
 $("#slick").slick({
   ...
   prevArrow: false,
   nextArrow: false,
   prevArrow:"<button class='icon-arrow a-left control-c prev slick-prev'>Back</button>",
   nextArrow:"<button class='a-right control-c next slick-next'>Next<span class='icon-arrow'></span></button>",
   appendArrows: $('.slider__footer'),
   appendDots: $('.slider__footer'),
